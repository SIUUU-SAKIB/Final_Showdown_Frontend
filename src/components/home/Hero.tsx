...
const Hero = () => {
  ...
  return (
    <div className={`max-w-screen min-h-[145vh] sm:min-h-[160vh] md:min-h-[180vh] lg:min-h-screen`}>
      <div className='min-w-screen bg-linear-to-r from-indigo-400/80 via-blue-500/80 to-cyan-400 max-h-[80vh] '>
        <div className={`${!scrolled ? "flex bg-transparent" : "hidden"}`}> <Nav /></div>
        {/* MAIN SECTION */}
        <div className="max-w-screen-2xl mx-auto bg-white min-h-[70vh] mt-4 lg:mt-20 flex flex-col lg:flex-row items-center justify-between gap-8 rounded-xl shadow-md p-4 lg:p-4 ">
          {/* image */}
