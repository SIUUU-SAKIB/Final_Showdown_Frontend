  ...
  <div className="w-full min-h-screen text-black">
      <div className="flex max-w-screen-2xl mx-auto gap-4 justify-between flex-col">
        ...
        <div className="flex items-center w-full px-8 py-8 gap-8">
          <div className="text-xl cursor-pointer w-full shadow bg-white text-black px-8 py-4 font-medium text-center hover:bg-black hover:text-white transition-all duration-300 rounded-lg">
            Total Projects: {totalProjects}
          </div>

          <Link
            href="/dashboard/create-project"
            className="text-xl cursor-pointer w-full shadow text-white border rounded-lg hover:bg-white border-white/20 px-8 py-4 font-medium text-center hover:text-black transition-all duration-300 "
          >
            Create new Project
          </Link>
        </div>
