...
const CreateBlog = () => {
  ...
  return (
    <div className='w-full py-12 min-h-screen px-4'>
      <div className='max-w-4xl md:min-w-4xl mx-auto flex flex-col items-center  gap-4 py-4  shadow-lg shadow-purple-500'>
        <h1 className='text-lg md:text-2xl font-semibold'>Create New Blog</h1>

        <form onSubmit={handleSubmit} className='w-full flex flex-col gap-4 py-2 px-4'>
